		...
		<div>
			...
			<form class="m-t" role="form" method="post" action="adddo.php">
				...
				<div class="form-group input-group">
					...
					<input type="text" class="form-control" placeholder="StudentId"
						name='studentId' />
				</div>


				<div class="form-group input-group">
					<span class="input-group-addon"><i class="fa fa-circle-o-notch"></i></span> <input
						type="text" class="form-control" placeholder="name" name='name' />
				</div>
				<div class="form-group input-group">
					<span class="input-group-addon"><i class="fa fa-university"></i></span> <input
						type="text" class="form-control" placeholder="className"
						name='className' />
				</div>
				<div class="form-group input-group">
				...
				<div class="form-group input-group" >
					...
					<input type='radio' name='sex' value='男' <?='男'?'checked':''?> />男
					<i class="fa fa-child"></i>
					<input type='radio' name='sex' value='女' <?='女'?'checked':''?> />女</span>
				</div>
				<div class="form-group input-group">
