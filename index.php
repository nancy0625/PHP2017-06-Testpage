    ...
    <div id="wrapper">
                    ...
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:0px;">
                                        <i class="fa fa-area-chart"></i>
                                        <strong class="font-bold"><img alt="" src="img/a8.jpg"></strong>
                                    </span>
                                </span>
                            </a>
                        </div>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.php">学生信息后台管理</a>
			</div>
			<div
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe id="J_iframe" width="100%" height="100%" src="index1.php?v=4.0" frameborder="0" data-id="index1.php" seamless></iframe>
            </div>
        </div>
        <!--右侧部分结束-->
    </div>
